...
Pink = Class{__includes = Entity}

function Pink:init(def)
...
function Pink:render()
    Entity.render(self)
end

function Pink:checkLeftCollisions(dt)
...
function Pink:checkRightCollisions(dt)
...
function Pink:checkObjectCollisions()
